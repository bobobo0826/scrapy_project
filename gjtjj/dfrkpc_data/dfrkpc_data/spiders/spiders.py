...
class Spider(CrawlSpider):
    ...
    def start_requests(self):
        url = "http://www.stats.gov.cn/tjsj/tjgb/rkpcgb/dfrkpcgb/"
    ...
    def parse(self, response):
        ...
        for item in urls:
            if "./" in item:
                url="http://www.stats.gov.cn/tjsj/tjgb/rkpcgb/dfrkpcgb/"+item.split("./")[1]
        ...
        for i in arr:
            ...
            if "下一页" in text:
                next_url = "http://www.stats.gov.cn/tjsj/tjgb/rkpcgb/dfrkpcgb/" + href
    ...
    def parse_url_to_html(self, response):
        ...
        name = name.replace(".", "。")
        html_path = 'D:/gjtjj/dfrkpc/html'
        pdf_path = 'D:/gjtjj/dfrkpc/pdf'
