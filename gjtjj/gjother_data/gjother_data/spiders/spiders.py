...
class Spider(CrawlSpider):
    ...
    def start_requests(self):
        url = "http://www.stats.gov.cn/tjsj/tjgb/qttjgb/"
    ...
    def parse(self, response):
        ...
        for item in urls:
            if "./" in item:
                url="http://www.stats.gov.cn/tjsj/tjgb/qttjgb/"+item.split("./")[1]
        ...
        for i in arr:
            ...
            if "下一页" in text:
                next_url = "http://www.stats.gov.cn/tjsj/tjgb/qttjgb/" + href
    ...
    def parse_url_to_html(self, response):
        ...
        name = name.replace(".", "。")
        html_path = 'D:/gjtjj/gjother/html'
        pdf_path = 'D:/gjtjj/gjother/pdf'
