...
class Spider(CrawlSpider):
    ...
    def start_requests(self):
        url = "http://www.stats.gov.cn/tjsj/tjgb/rdpcgb/dfpcgb/"
    ...
    def parse(self, response):
        ...
        for item in urls:
            if "./" in item:
                url="http://www.stats.gov.cn/tjsj/tjgb/rdpcgb/dfpcgb/"+item.split("./")[1]
        ...
        for i in arr:
            ...
            if "下一页" in text:
                next_url = "http://www.stats.gov.cn/tjsj/tjgb/rdpcgb/dfpcgb/" + href
    ...
    def parse_url_to_html(self, response):
        ...
        name = name.replace(".", "。")
        html_path = 'D:/gjtjj/dfrd/html'
        pdf_path = 'D:/gjtjj/dfrd/pdf'
